...
export const mockDrugs: Drug[] = [
  {
    ...
    status: "manufactured", // This will be dynamically updated
    currentOwnerId: "user1", // This will be dynamically updated
    currentOwnerName: "ZenPharma Inc.", // This will be dynamically updated
    currentOwnerRole: "manufacturer" // This will be dynamically updated
  },
  {
    id: "d2",
    gtin: "01234567890124",
    ...
    status: "shipped", // This will be dynamically updated
    currentOwnerId: "user2", // This will be dynamically updated
    currentOwnerName: "MediDistribute LLC", // This will be dynamically updated
    currentOwnerRole: "distributor" // This will be dynamically updated
  },
  {
    id: "d3",
    gtin: "01234567890125",
    ...
    status: "received", // This will be dynamically updated
    currentOwnerId: "user3", // This will be dynamically updated
    currentOwnerName: "ZenMed Pharmacy", // This will be dynamically updated
    currentOwnerRole: "dispenser" // This will be dynamically updated
  },
  // A drug with an anomalous flow (skips distributor)
  {
    ...
    status: "dispensed", // This will be dynamically updated
    currentOwnerId: "user3", // This will be dynamically updated
    currentOwnerName: "ZenMed Pharmacy", // This will be dynamically updated
    currentOwnerRole: "dispenser" // This will be dynamically updated
  },
  // A drug with a gap in its timeline
  {
    ...
    status: "warehoused", // This will be dynamically updated
    currentOwnerId: "user2", // This will be dynamically updated
    currentOwnerName: "MediDistribute LLC", // This will be dynamically updated
    currentOwnerRole: "distributor" // This will be dynamically updated
  }
...
export function computeDrugStatus(drugId: string): {
  ...
  return {
    status,
    currentOwnerId: latestEvent.actor.id,
    currentOwnerName: latestEvent.actor.organization,
    currentOwnerRole: latestEvent.actor.role
  };
}
